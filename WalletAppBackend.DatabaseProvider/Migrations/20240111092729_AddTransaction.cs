        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Users_UserRecipientId",
                        column: x => x.UserRecipientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_Users_UserSenderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UserRecipientId",
                table: "Transactions",
                column: "UserRecipientId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UserSenderId",
                table: "Transactions",
                column: "UserSenderId");
        }
